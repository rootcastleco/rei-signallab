...
[![Firebase](https://img.shields.io/badge/Firebase-Hosting-FFCA28?style=for-the-badge&logo=firebase&logoColor=black)](https://signallab-3305b.web.app)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=for-the-badge)](LICENSE)

[Topics](#repository-topics) | [Overview](#overview) | [Signal Flow Studio](#1-typed-node-based-signal-flow-studio-rei-signal) | [Features](#key-features) | [Matplotlib API](#matplotlib-backend-plot-rendering-api) | [API Spec](#api-endpoints-summary) | [Quick Start](#quick-start)
...
`digital-signal-processing` `dsp` `signal-flow-graph` `node-based-canvas` `oscilloscope` `spectrum-analyzer` `python-sandbox` `fastapi` `matplotlib` `scipy` `react` `vite` `spectrogram` `signal-processing` `thd-measurement` `snr-calculation` `biquad-filter` `file-upload`
...
- Execution environment protected by restricted `__builtins__` and 5MB stdout output quotas (`POST /api/python/execute`).
